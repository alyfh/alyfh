...
function caculatorCircle() {
	...
	if (mark1 % 10 == 0) {
		var tinyEnemy = new Enemy( randomValue(0, 320-34), -24, 34, 24, 'image/enemy1_fly_1.png');
		enemys.push(tinyEnemy);
	}

	if (mark2 % 50 ==0) {
		var midEnemy = new Enemy( randomValue(0, 320-46), -60, 46, 60, 'image/enemy3_fly_1.png');
		enemys.push(midEnemy);
	}

	if (mark3 % 150== 0) {
		var bigEnemy = new Enemy( randomValue(0, 320-110), -164, 110, 164, 'image/enemy2_fly_1.png');
